<header>
                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            @auth
                                <a href="{{route('dashboard')}}" class=" text-white @if($item['active']) bg-gray-900 text-gray-300 @else hover:bg-gray-700 @endif hover:text-white px-3 py-2 rounded-md text-sm font-medium">Dashboard</a>
                            @endauth
    ...
    <div class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        ...
        @foreach($menu as $item)
        <a href="{{$item['url']}}" class= "text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium" aria-current="page">{{$item['title']}}</a>
        @endforeach
          @auth
              <a href="{{ url('/dashboard') }}" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Home</a>
          @else
      ...
      <div class="border-t border-gray-700 pt-4 pb-3">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            ...
            <div class="text-sm font-medium leading-none text-gray-400">admin@mail.com</div>
          </div>
