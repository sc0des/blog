            ...
            <div class="flex h-16 items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        ...
                        @endforeach
                        @auth
                            <a href="{{route('dashboard')}}" class=" text-white @if($item['active']) bg-gray-900 text-gray-300 @else hover:bg-gray-700 @endif hover:text-white px-3 py-2 rounded-md text-sm font-medium">Home</a>
                        @endauth
                        </div>
                    </div>
